...
use Taler\Api\Instance\Actions\DeleteAccessTokenBySerial;
use Taler\Api\Instance\InstanceClient;
use Taler\Exception\TalerException;
use Psr\Http\Message\ResponseInterface;

class DeleteAccessTokenBySerialTest extends TestCase
{
    ...
    public function testRunSuccess204(): void
    {
        ...
        $httpClient->expects($this->once())
            ->method('request')
            ->with('DELETE', 'instances/test-instance/private/tokens/123', [],)
            ->willReturn($this->response);

        DeleteAccessTokenBySerial::run($this->instanceClient, 'test-instance', 123);
    ...
    public function testRunAsync(): void
    {
        ...
        $result = DeleteAccessTokenBySerial::runAsync($this->instanceClient, 'test-instance', 123);
