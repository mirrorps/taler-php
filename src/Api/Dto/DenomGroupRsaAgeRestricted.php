...
/**
 * DTO for age-restricted RSA-based denomination groups
 */
class DenomGroupRsaAgeRestricted extends AbstractDenomGroup
{
    private const CIPHER = 'RSA+age_restricted';
